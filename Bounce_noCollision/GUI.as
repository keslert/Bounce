package  {
	...
	public class GUI extends MovieClip{
		...
		private function showScore():void {
			...
			scoreGUI.totalBouncesNumText.text = ""+GLOBAL.totalBounces;
		...
		private function submitScoreClicked(e:MouseEvent) {
			...
			MochiScores.showLeaderboard({boardID: boardID, score: GLOBAL.totalBounces});
		...
		public function resetCircles(i:int):void {
			circles.reset(i);
		}
	}
}
